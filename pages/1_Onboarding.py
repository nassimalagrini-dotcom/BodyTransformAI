...
# Custom CSS to show sidebar on this page and hide the Main.py black background
st.markdown("""
    <style>
...
# --- NAVIGATION ---
# This button takes them back to the Black Landing Page
    ...
    with st.form("onboarding_form"):
        ...
        with col1:
            ...
            if unit_system == "Metric (kg/cm)":
                ...
                final_weight = weight_lbs * 0.453592
        ...
        with col2:
            if unit_system == "Metric (kg/cm)":
                ...
                final_height = (feet * 30.48) + (inches * 2.54)

            activity = st.selectbox("Activity Level", ["Mostly Sitting", "Light Movement", "Active Job", "Very Athletic"])
